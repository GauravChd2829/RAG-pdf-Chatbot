...
def main():
    ...
    # Redirect immediately if login screen is active
        ...
        st.markdown('<h1 style="text-align:left;">🔐  AI Fortress Server </h1>', unsafe_allow_html=True)
        st.markdown('<h2 style="text-align: left;">Upload your material for Rag </h2>', unsafe_allow_html=True)
